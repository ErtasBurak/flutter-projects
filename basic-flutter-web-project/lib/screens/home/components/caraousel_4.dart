...
class Carousel_4 extends StatefulWidget {
  const Carousel_4({
    Key? key,
  }) : super(key: key);

  @override
  State<Carousel_4> createState() => _CarouselState();
}

class _CarouselState extends State<Carousel_4> {
  late PageController _pageController;

  List<String> images = [
    "assets/images/Halfeti Konak/render_6 - Foto.jpg",
    "assets/images/Halfeti Konak/render_7 - Foto.jpg",
    "assets/images/Halfeti Konak/render_8 - Foto.jpg",
    "assets/images/Halfeti Konak/render_9 - Foto.jpg",
    "assets/images/Halfeti Konak/render_10 - Foto.jpg",
