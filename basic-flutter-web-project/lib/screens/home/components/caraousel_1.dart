...
class Carousel_1 extends StatefulWidget {
  const Carousel_1({
    Key? key,
  }) : super(key: key);

  @override
  State<Carousel_1> createState() => _CarouselState();
}

class _CarouselState extends State<Carousel_1> {
  late PageController _pageController;

  List<String> images = [
    "assets/images/Tostçu/renders_3 - Foto.jpg",
    "assets/images/Tostçu/renders_4 - Foto.jpg",
    "assets/images/Tostçu/renders_5 - Foto.jpg",
    "assets/images/Tostçu/renders_6 - Foto.jpg",
    "assets/images/Tostçu/renders_7 - Foto.jpg",
    "assets/images/Tostçu/renders_8 - Foto.jpg"
  ];
